...
public class 부품만들기1 {
	public static void main(String[] args) {
		...
		f.setLayout(flow);
		//
		ImageIcon icon = new ImageIcon("019.png");
		...
		input3.setBackground(Color.blue); //배경색
		input3.setForeground(Color.white); //버튼의 위색, 글자색
		input4.setBackground(Color.blue); //배경색
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String nm = input3.getText();
				String ph = input4.getText();
				
				if (id.equals("admin") && pw.equals("1234") && nm.equals("kim") && ph.equals("012")) {
